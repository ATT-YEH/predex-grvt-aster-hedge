...
Supported exchanges:
    ...
    - grvtaster: Uses HedgeBot from hedge_mode_grvtaster.py (GRVT + Aster)新增的
...
Examples:
    ...
    python hedge_mode.py --exchange grvt --ticker ETH --size 0.05 --iter 20
        """
    )

    parser.add_argument('--exchange', type=str, required=True,
                        help='Exchange combo to use (e.g., backpack, extended, grvt)')
